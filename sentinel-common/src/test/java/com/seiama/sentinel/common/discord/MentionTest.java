...
class MentionTest {
  @Test
  void testUserWithId() {
    assertEquals("<@105923848263753728> (`@creamfilled.` / `105923848263753728`)", Mention.userWithId(Snowflake.of("105923848263753728"), "creamfilled.", Discriminator.TEMPORARY_MIGRATION_MARKER));
